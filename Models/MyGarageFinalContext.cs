...
=> optionsBuilder.UseSqlServer("Data Source=LAPTOP-EPHRHHHM;Initial Catalog=MyGarage;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
