...
public partial class MyGarageFinalContext : DbContext
{
    ...
    public virtual DbSet<AppointmentProductDetail> AppointmentProductDetails { get; set; }
...
=> optionsBuilder.UseSqlServer("Data Source=LAPTOP-K74LGB4H\\SQL2019;Initial Catalog=MyGarageFinal79;User ID=sa;Password=vanlinh@1327;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AppointmentVehicleDetailId);
            ...
            entity.HasOne(d => d.Appointment)
                .WithMany(p => p.AppointmentVehicleDetails)
        ...
        modelBuilder.Entity<AppointmentProductDetail>(entity =>
        {
            entity.HasKey(e => e.AppointmentProductDetailId);
            entity.Property(e => e.AppointmentProductDetailId).ValueGeneratedOnAdd();
            entity.Property(e => e.UnitPrice).HasColumnType("decimal(18,2)");

            entity.HasOne(e => e.Appointment)
                .WithMany(a => a.AppointmentProductDetails)
                .HasForeignKey(e => e.AppointmentId)
                .OnDelete(DeleteBehavior.Cascade);

            entity.HasOne(e => e.Product)
                .WithMany(p => p.AppointmentProductDetails)
