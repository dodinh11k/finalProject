...
namespace test_2.Models
{
    public class MultiVehicleAppointmentViewModel
    {
        ...
        public List<Microsoft.AspNetCore.Mvc.Rendering.SelectListItem> ProductList { get; set; } = new();

        public List<ReplacementProductItem> ReplacementProducts { get; set; } = new();
    }
