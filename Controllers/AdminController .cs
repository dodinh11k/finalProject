...
namespace test_2.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Dashboard()
        {
            ...
            // 1. Weekly Sales: tổng số sản phẩm bán được trong tuần (giữ nguyên)
            ...
            // Lấy top 5 technician năng suất nhất (số lịch hoàn thành nhiều nhất)
            ...
            var topTechnicians = await _context.Users
                ...
                .Select(u => new {
                    ...
                    TotalCompleted = _context.Appointments.Count(a => a.TechnicianId == u.UserId && a.Status == "Completed"),
                    LastCompletedAt = _context.Appointments
                        .Where(a => a.TechnicianId == u.UserId && a.Status == "Completed")
