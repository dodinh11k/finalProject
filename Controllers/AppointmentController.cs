    ...
    public async Task<IActionResult> Create(AppointmentViewModel model)
    {
        ...
        try
        {
            ...
            var appointment = new Appointment
            {
                ...
                TechnicianId = null, // <-- Để null, chưa phân công
            ...
            // Tạo chi tiết dịch vụ cho từng dịch vụ được chọn
            ...
            // Lấy thông tin cần thiết cho email (lấy tên các dịch vụ)
            ...
            if (appointment.TechnicianId != null)
            {
                ...
                technicianName = technicianInfo?.FullName ?? technicianInfo?.Username ?? "Không xác định";
            }
